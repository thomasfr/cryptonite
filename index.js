...
console.log('PRIV', keypair.toPrivatePem('utf8').replace(/\n/g,''));
//console.log('MOD', keypair.getModulus().toString('hex'));
//console.log('EXP', keypair.getExponent().toString('hex'));
console.log();
console.log('PUB', keypair.toPublicPem('utf8').replace(/\n/g,''));


//var publicKey = rsa.createPublicKey(publicPem);
//console.log(publicKey.encrypt(secret).toString('hex'))
